...
class MedalAnim(val context: Context, val drawableId:Int, val drawableId2:Int) {
...
//    }
    ...
    init {
        ...
        val vertexShader: Int = loadShaderFromAssets(GLES32.GL_VERTEX_SHADER, "shaders/medal-anim.vertexshader")
        val fragmentShader: Int = loadShaderFromAssets(GLES32.GL_FRAGMENT_SHADER, "shaders/medal-anim.fragmentshader")
