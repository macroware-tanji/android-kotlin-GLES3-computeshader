...
class StarCircle(val context: Context, val drawableId:Int) {
...
//    }
    ...
    init {
        ...
        val vertexShader: Int = loadShaderFromAssets(GLES32.GL_VERTEX_SHADER, "shaders/star-circle.vertexshader")
        val fragmentShader: Int = loadShaderFromAssets(GLES32.GL_FRAGMENT_SHADER, "shaders/star-circle.fragmentshader")
