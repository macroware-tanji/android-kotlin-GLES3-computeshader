...
class TexMap4(context: Context, drawableId:Int, period:Float, direction:Float) {
...
//    }
    ...
    init {
        ...
        val vertexShader: Int = loadShaderFromAssets(GLES32.GL_VERTEX_SHADER, "shaders/texmap-4.vertexshader")
        val fragmentShader: Int = loadShaderFromAssets(GLES32.GL_FRAGMENT_SHADER, "shaders/texmap-4.fragmentshader")
...
//    private val uvStride: Int = UV_COORDS_PER_VERTEX * 4 // 4 bytes per vertex
    ...
    fun draw(viewSize:Vec2, texSize:Vec2, texPos:Vec2) {
        ...
        vertInfo.put(6,period)
        vertInfo.put(7,direction)
        vertInfo.put(8,time)
