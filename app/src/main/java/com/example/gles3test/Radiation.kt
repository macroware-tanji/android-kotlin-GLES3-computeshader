...
class Radiation(context: Context) {
    ...
    init {
        ...
        val vertexShader: Int = loadShaderFromAssets(GLES32.GL_VERTEX_SHADER, "radiation-0.vertexshader")
        val fragmentShader: Int = loadShaderFromAssets(GLES32.GL_FRAGMENT_SHADER, "radiation-0.fragmentshader")
