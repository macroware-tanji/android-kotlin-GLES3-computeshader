...
class MSDFOutline(context: Context, drawableId:Int) {
    ...
    private var fragInfo = FloatBuffer.allocate(8)

    init {
        this.context = context
        val vertexShader: Int = loadShaderFromAssets(GLES32.GL_VERTEX_SHADER, "msdf-0.vertexshader")
        val fragmentShader: Int = loadShaderFromAssets(GLES32.GL_FRAGMENT_SHADER, "msdfoutline-0.fragmentshader")
